...
public class EditCustomerActivity extends AppCompatActivity implements Response.Listener<JSONObject>, View.OnClickListener
{
    ...
    private void cargar ()
    {
        ...
        JsonObjectRequest jsonObjectRequest
                ...
                "https://storeitc-luisitoaltamira.rhcloud.com/wc-api/v3/customers/"+customer.getId(),null,
                this,api)
        {
            @Override
    ...
    private void actualiza ()
    {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.PUT,"https://storeitc-luisitoaltamira.rhcloud.com/wc-api/v3/customers/"+customer.getId(),jsonCustomer,this,api)
        {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
                return api.headers();
