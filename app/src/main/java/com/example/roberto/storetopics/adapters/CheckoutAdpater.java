...
/**
 * Created by roberto on 12/12/16.
 */

public class CheckoutAdpater extends BaseAdapter {
    private Context context;
    private List<Products> productos;
    ImageView img1;


    public CheckoutAdpater(Context context, List<Products> productos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //linear=(LinearLayout) rowView.findViewById(R.id.lineLayout);
        ...
        try {
           ...
           /* linear.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(context,String.valueOf("holi"),Toast.LENGTH_SHORT).show();
